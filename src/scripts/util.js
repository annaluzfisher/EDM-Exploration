...
export {  hiddenSpace, startTheShow, data, bubbles, innerContentBox, contentBox, button, tree, mainContent, overview, thePage, dots, startPage, toggleOverviewVisibility }
